...
def build_lm(args, data_lower, vocab_str):
    ...
    print("\nBuilding lm.binary ...")
    binary_path = os.path.join(args.output_dir, "lm.klm")
...
def main():
    ...
    parser.add_argument(
        "--output_dir", help="Directory path for the output", type=str,default="/home/ilman/Desktop", required=False
    )
    parser.add_argument(
        "--top_k",
    ...
    parser.add_argument(
        ...
        type=str,default="/home/ilman/Desktop/kenlm-master/build/bin/",
        required=False,
    )
    parser.add_argument(
        "--arpa_order",
    ...
    os.remove(os.path.join(args.output_dir, "vocab-500000.txt"))
